## Домашнее задание на каникулы (до 16.10)
1. Прочитать текст Плунгяна (файл "Плунгян В. А...." в этой папке). По нему будет самостоятельная
2. Выкладываю задачи (файл "задачи в лагерь" тут же). Учёт сданных задачек будет здесь: https://docs.google.com/spreadsheets/d/1v33dUABiRgZFSKNmTkSIFBCN_sZ_81siRW9BO5rwCg0/edit?usp=sharing

Словарь питона - https://github.com/purlubru/school/wiki

## Домашнее задание на 15.05
### Лингвистика
Прочитать статьи Ирины Левонтиной, по ним будет тест.
1. https://trv-science.ru/2012/05/22/argumentirujjte-argumentiruyu/
2. https://trv-science.ru/2012/06/05/to-chto-skryto/

## Домашнее задание на 08.05
### Информатика
Написать программу, которая проверяет правильность расстановки скобок. То есть на первый пример она должна вам вывести, что всё правильно, а на второй - что неправильно
>((2+3)/7)-4
>
>He smiled (because he liked it (the sun)

Задание надо делать через стек. Как работает стек можно посмотреть в файле stack.py в папке информатика. Задавайте вопросы, если непонятно!
