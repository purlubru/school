...
### Лингвистика
Найти в международном фонетическом алфавите все звуки, которые есть в русском языке. Если вы потеряли бумажку, выкладываю тот же файл сюда (ipa.pdf). Лучше выделить каким-нибудь цветом прямо в таблице и прислать.
